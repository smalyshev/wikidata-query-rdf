...
public class WikibaseGeoExtensionIntegrationTest extends AbstractUpdateIntegrationTestBase {
    ...
    private void insertPoints() {
        String query = "INSERT {\n" +
                "<http://Berlin> wdt:P625 \"Point(52.516666 13.38333)\"^^geo:wktLiteral .\n" +
                "<http://Bremen> wdt:P625 \"Point(53.07694 8.808888)\"^^geo:wktLiteral .\n" +
                "<http://Barcelona> wdt:P625 \"Point(41.3825 2.17694)\"^^geo:wktLiteral .\n" +
                "<http://SanFrancisco> wdt:P625 \"Point(37.76666 -122.43333)\"^^geo:wktLiteral .\n" +
                "<http://Johannesburg> wdt:P625 \"Point(-26.145 2.77777)\"^^geo:wktLiteral .\n" +
                "<http://MoonBerlin> wdt:P625 \"<" + moonURI + "> Point(52.516666 13.38333)\"^^geo:wktLiteral .\n" +
                "<http://MoonBremen> wdt:P625 \"<" + moonURI + "> Point(53.07694 8.808888)\"^^geo:wktLiteral .\n" +
                "} WHERE {}";
    ...
    public void circleSearch() throws QueryEvaluationException {
        ...
        TupleQueryResult results = rdfRepository().query(
                ...
                " bd:serviceParam wikibase:center \"Point(52.516666 13.38333)\"^^geo:wktLiteral .\n" +
    ...
    public void boxSearch() throws QueryEvaluationException {
        ...
        TupleQueryResult results = rdfRepository().query(
                ...
                "  ?place wdt:P625 ?location .\n" +
                " bd:serviceParam wikibase:cornerSouthWest \"Point(-50 -180)\"^^geo:wktLiteral .\n" +
                " bd:serviceParam wikibase:cornerNorthEast \"Point(50 180)\"^^geo:wktLiteral .\n" +
                " }} ORDER BY ?place\n "
        );
